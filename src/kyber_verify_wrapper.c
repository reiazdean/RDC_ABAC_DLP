#include <stddef.h>
#include <stdint.h>
#include "../CrystalsKyber/ref/verify.h"
...
int verify(const uint8_t* a, const uint8_t* b, size_t len)
{
    ...
    //return (-(uint64_t)r) >> 63;//THIS LINE FAILS IN verify.c, so I replace the file with a wrapper so I don't have to modify the Kyber source
    return (-(int64_t)r) >> 63;
}
